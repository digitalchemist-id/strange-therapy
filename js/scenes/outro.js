...
function outro_questions_tests(){
	...
	switch($.test_correct){
		...
		case 0:
			...
			break;
		case 1:
			P.s("You got one right");
			M.s("Man...");
			P.s("You asked for it");
			M.s("I guess you can't get lucky twice");
			break;
		case 2:
			P.s("You got half of them right");
			P.s("That's two");
			M.s("Not bad");
			M.s("I did alright");
			M.s("Right?");
			...
			break;
		case 3:
			P.s("You got three out of four right");
			P.s("Which is impressive");
			M.s("Ha! I nailed it");
			P.s("Great job");
			M.s("Oh I'm flattered");
			break;
		case 4:
			P.s("You got all four right");
			M.s("Thought so");
			P.s("Are you from a chemistry background? Or...");
			M.s("Come on");
			M.s("For real?");
			P.s("Okay... Nevermind");
			break;
...
function outro_life(){
	...
	C.s({
        "You don't have to be so hard on yourself": function(msg) {
            P.s(msg);
        ...
        "We all learn it the hard way": function(msg) {
            P.s(msg);
            M.s("I guess they do");
            C.hide();
            outro_life_1();
...
function outro_life_1(){
	...
	M.s("I had to get a knee surgery from my childhood injury");
	M.s("I stayed in bed for months so I took off a semester from school");
	M.s("With a lot of time in my hands, I often looked back to two years ago");
	M.s("The dark times... and a story");
	M.s("The story that I've never told anyone about");
	M.s("The story that I've put behind but also keep looking back");
	M.s("So I opened up a fake therapy session-");
	...
	M.s("And also what I didn't even wanna even imagine happening-");
...
function outro_love(){
	...
	M.s("I took a break and went out to drink some water from a purifier");
	...
	M.s("I searched if there's anything like an animal shelter or animal protect facility exists near me");
	...
	M.s("They said they'll come pick him up later that night, so in the meantime I took him home and gave him something to it");
	...
	M.s("Two male adults tried to push and pull him in but he didn't even budge");
	P.s("Was he big?");
	...
	M.s("Anyway...");
	M.s("I just couldn't watch him getting forced in, and with all that resistance");

...
//introducing my girlfriend and my friend
...
async function start_metro1(){
	...
	// P.t('So...');
	// P.t('Next test is...');
	// P.t("It's this Saturday");
	// Q.wait(1000);
	// P.t("Wait...");
	// P.t("Maybe I might have time to visit home");
	// P.t("Tomorrow's classes are either canceled or over");
	// P.t("And I don't have classes on Fridays")
	Q.wait(1000);
...
function metro1_gf_dialogue_2() {
	...
	C.s({
	    ...
	    "And I never liked it": function(msg) {
	    	...
	    	P.s(msg);
	    	Q.wait(1000);
	    	Gf.s("I see that you certainly don't");
	    	C.hide();
	    	metro1_gf_dialogue_3();
	    },
	    "...": function(msg) {

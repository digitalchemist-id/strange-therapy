...
***************/
class Message {
    constructor(txt, align, bgColor, txtColor, sound) {
        this.txt = txt;
        this.alpha = 0.7;
        this.align = align;
    ...
    draw() {
        ...
        Q.queue += Math.floor(txtLength / 2) + 50; //adjusts speed of autoskip
    ...
    async t(obj) {
        Q.fqueue.push(function () {
            ...
            for (var i = 0; i < this.n; ++i) {
                ...
                this.button[i].on('pointerdown', (function (callback, message) {
                    return function () { callback(message); };
                })(obj[labels[i]], labels[i]));
            }
        }.bind(this)); //From ncase/coming-out-simulator-2014
